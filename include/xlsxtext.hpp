...
namespace xlsxtext
{
    ...
    public:
        ...
        const auto &rows() const noexcept { return _rows; }
    ...
    public:
        ...
        const auto &worksheets() const noexcept { return _worksheets; }
        auto begin() const noexcept { return _worksheets.begin(); }
        auto end() const noexcept { return _worksheets.end(); }
    };
} // namespace xlsxtext